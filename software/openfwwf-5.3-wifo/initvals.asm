...
.initvals(b0g0initvals5)
	...
	mmio32 0x4, MMIO_MACCMD
        ...
        /* initialized MMIO_RXE_RXCOPYLEN and COPYOFFSET */
	...
	// 0x0022: ACK/CTS PHY control word (SHM_ACKCTSPHYCTL) = 0, used by ucode and b43
        ...
        // 0x0054: [(00 00) (05 7E)] [(FF FF) (FF FF)] [(00 0A) (00 00)]
        ...
        mmio32 0x057E0000, MMIO_SHM_DATA
        ...
        mmio32 0x03200320, MMIO_SHM_DATA
        mmio32 0x03200320, MMIO_SHM_DATA
        mmio32 0x03200320, MMIO_SHM_DATA
        mmio32 0x03200320, MMIO_SHM_DATA
        mmio32 0x0348035C, MMIO_SHM_DATA        // high: addr for 24Mb/s ACK, low: addr for 48Mb/s ACK
        mmio32 0x03200334, MMIO_SHM_DATA        // high: addr for 6Mb/s ACK, low: addr for 12Mb/s ACK
        mmio32 0x03520366, MMIO_SHM_DATA        // high: addr for 36Mb/s ACK, low: addr for 54Mb/s ACK
        mmio32 0x032A033E, MMIO_SHM_DATA        // high: addr for 9Mb/s ACK, low: addr for 18Mb/s ACK
	...
	mmio32 0x03200320, MMIO_SHM_DATA
	mmio32 0x03200320, MMIO_SHM_DATA
	mmio32 0x0348035C, MMIO_SHM_DATA
	mmio32 0x03200334, MMIO_SHM_DATA
	mmio32 0x03520366, MMIO_SHM_DATA
	mmio32 0x032A033E, MMIO_SHM_DATA

	// 0x0080 * 4
	mmio32 0x03700370, MMIO_SHM_DATA
	mmio32 0x03700370, MMIO_SHM_DATA
	mmio32 0x0370037B, MMIO_SHM_DATA
	mmio32 0x03860370, MMIO_SHM_DATA
	mmio32 0x03700370, MMIO_SHM_DATA
	mmio32 0x03700370, MMIO_SHM_DATA
	mmio32 0x03700370, MMIO_SHM_DATA
	mmio32 0x03700391, MMIO_SHM_DATA
	...
	// 0x00A0 * 4 CW??
	mmio32 0x030100A0, MMIO_SHM_CONTROL
	mmio32 0x001F0000, MMIO_SHM_DATA
	mmio32 0x001F03FF, MMIO_SHM_DATA
	mmio32 0x00000001, MMIO_SHM_DATA
	mmio32 0x00000001, MMIO_SHM_DATA
	...
	// 0x00A8 * 4 CW??
	mmio32 0x030100A8, MMIO_SHM_CONTROL
	mmio32 0x001F0000, MMIO_SHM_DATA
	mmio32 0x001F03FF, MMIO_SHM_DATA
	mmio32 0x00000001, MMIO_SHM_DATA
	mmio32 0x00000001, MMIO_SHM_DATA
	...
	mmio32 0x00600000, MMIO_SHM_DATA
	...
	// Other tables	0x1C3 * 2 = 0x386, 0x1C3 * 4 = 0x70C, up to 0x733 included
	mmio32 0x030101C3, MMIO_SHM_CONTROL
	mmio32 0x04370022, MMIO_SHM_DATA	// 70C
	mmio32 0x00000015, MMIO_SHM_DATA	// 710
	mmio32 0x043700DF, MMIO_SHM_DATA	// 714
	mmio32 0xC02C0065, MMIO_SHM_DATA	// 718
	mmio32 0x0000012E, MMIO_SHM_DATA	// 71C
	mmio32 0x00110000, MMIO_SHM_DATA	// 720
	mmio32 0x000B846E, MMIO_SHM_DATA	// 724
	mmio32 0x00D40000, MMIO_SHM_DATA	// 728
	mmio32 0x0033846E, MMIO_SHM_DATA	// 72C
	mmio32 0x00FCC02C, MMIO_SHM_DATA	// 730 -> 733 included

	// registers r00-r63
	mmio32 0x00020003, MMIO_SHM_CONTROL
	mmio32 0x0000001F, MMIO_SHM_DATA

	mmio32 0x00020004, MMIO_SHM_CONTROL
	mmio32 0x000003FF, MMIO_SHM_DATA

	mmio32 0x00020005, MMIO_SHM_CONTROL
	mmio32 0x0000001F, MMIO_SHM_DATA

	mmio32 0x00020006, MMIO_SHM_CONTROL
	mmio32 0x00000007, MMIO_SHM_DATA

	mmio32 0x00020007, MMIO_SHM_CONTROL
	mmio32 0x00000004, MMIO_SHM_DATA

	mmio32 0x00020008, MMIO_SHM_CONTROL
	mmio32 0x0000FFFF, MMIO_SHM_DATA

	mmio32 0x00020009, MMIO_SHM_CONTROL
	mmio32 0x00000000, MMIO_SHM_DATA

	mmio32 0x0002000A, MMIO_SHM_CONTROL
	mmio32 0x00000000, MMIO_SHM_DATA

	mmio32 0x0002000B, MMIO_SHM_CONTROL
	mmio32 0x00000000, MMIO_SHM_DATA

	mmio32 0x0002000C, MMIO_SHM_CONTROL
	mmio32 0x00000000, MMIO_SHM_DATA

	mmio32 0x0002000D, MMIO_SHM_CONTROL
	mmio32 0x00000000, MMIO_SHM_DATA

	mmio32 0x0002000E, MMIO_SHM_CONTROL
	mmio32 0x00000000, MMIO_SHM_DATA

	mmio32 0x0002000F, MMIO_SHM_CONTROL
	mmio32 0x00000000, MMIO_SHM_DATA

	mmio32 0x00020010, MMIO_SHM_CONTROL
	mmio32 0x0000001F, MMIO_SHM_DATA

	mmio32 0x00020011, MMIO_SHM_CONTROL
	mmio32 0x00000000, MMIO_SHM_DATA

	mmio32 0x00020012, MMIO_SHM_CONTROL
	mmio32 0x00000000, MMIO_SHM_DATA

	mmio32 0x00020013, MMIO_SHM_CONTROL
	mmio32 0x00000000, MMIO_SHM_DATA

	mmio32 0x00020014, MMIO_SHM_CONTROL
	mmio32 0x00000100, MMIO_SHM_DATA

	mmio32 0x00020015, MMIO_SHM_CONTROL
	mmio32 0x00000000, MMIO_SHM_DATA

	mmio32 0x00020016, MMIO_SHM_CONTROL
	mmio32 0x00000000, MMIO_SHM_DATA
.initvals(b0g0bsinitvals5)
	...
	mmio32 0x10192, MMIO_SHM_CONTROL
	mmio16 0x3C, MMIO_SHM_DATA

	mmio32 0x10197, MMIO_SHM_CONTROL
	mmio16 0x34, MMIO_SHM_DATA

	mmio32 0x1019C, MMIO_SHM_CONTROL
	mmio16 0x30, MMIO_SHM_DATA

	mmio32 0x101A1, MMIO_SHM_CONTROL
	mmio16 0x2C, MMIO_SHM_DATA

	mmio32 0x101A6, MMIO_SHM_CONTROL
	mmio16 0x2C, MMIO_SHM_DATA

	mmio32 0x101AB, MMIO_SHM_CONTROL
	mmio16 0x28, MMIO_SHM_DATA

	mmio32 0x101B0, MMIO_SHM_CONTROL
	mmio16 0x28, MMIO_SHM_DATA

	mmio32 0x101B5, MMIO_SHM_CONTROL
	mmio16 0x28, MMIO_SHM_DATA
